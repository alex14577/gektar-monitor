/* settings.js — SMTP provider suggestion and app-password hint
 * for the settings page SMTP form.
 */
(function () {
  'use strict';

  var loginEl    = document.getElementById('smtp-user');
  var hostEl     = document.getElementById('smtp-host');
  var portEl     = document.getElementById('smtp-port');
  var advancedEl = document.getElementById('settings-smtp-advanced');
  var hintEl     = document.getElementById('settings-smtp-app-password-hint');
  var hintLabel  = document.getElementById('settings-smtp-provider-label');
  var hintLink   = document.getElementById('settings-smtp-app-password-link');
